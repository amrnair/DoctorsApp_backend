...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'amruthasnair0502@gmail.com', // this is the email that will be used to send the email.
        pass: 'yjwl rvty pvtj nuoa', //this is the password that is created in app passwords in gmail setting options.
    },
});
